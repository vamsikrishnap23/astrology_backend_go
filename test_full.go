...
func main() {
	...
	input := domain.BirthInput{
		DateOfBirth: "1975-03-11", TimeOfBirth: "03:15:00",
		Latitude: 16.42593, Longitude: 79.54041,
		Timezone: 5.5, Ayanamsa: "KP", HouseSystem: "Placidus",
	}
	...
	ctx := &domain.CalculationContext{
		...
		UTCTime: utcTime, JulianDayUT: jd,
	}
	...
	ioutil.WriteFile("aspects.json", b, 0644)
	fmt.Println("Done")
}
