...
import (
	...
	"github.com/vamsi/astrology_backend_go/internal/astrology/bhava_chalit"
...
func BhavaChalitHandler(w http.ResponseWriter, r *http.Request) {
	...
	res, err := bhava_chalit.CalculateBhavaChalit(&ctx)
	if err != nil {
